  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 mb-3 relative z-10">
        <h3
          className="text-xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#1580de] to-[#692097]
      ...
      <p className="text-gray-400 text-sm leading-relaxed grow mb-6 relative z-10">
        {project.description}
      </p>
      <div className="flex items-center gap-5 text-xl mt-auto relative z-10">
        {project.github && (
          <motion.a
            href={project.github}
            target="_blank"
