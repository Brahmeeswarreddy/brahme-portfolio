...
export default function Home() {
  ...
  const bio = (
    <p className="text-base sm:text-lg text-gray-300 leading-relaxed">
      Full Stack Developer with experience building scalable, accessible
    ...
    >
      ...
      <div className="relative z-10 min-h-screen max-w-6xl mx-auto px-6 md:px-10 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-x-12 items-center py-32 lg:py-0">
        <div className="lg:col-span-7 flex flex-col gap-6 text-center lg:text-left items-center lg:items-start">
          ...
          >
            <span className="block text-2xl sm:text-5xl md:text-6xl font-bold text-purple-600">
              Hi, I'm
            </span>
            <span className="block text-3xl sm:text-3xl font-bold text-white mt-1 lg:whitespace-nowrap">
          ...
          >
            <a
              ...
              className="px-6 py-3 rounded-full font-medium text-white
                         ...
                         shadow-lg transition-all hover:brightness-125"
            >
              View my Work
            </a>
            {/* <a
              href="/resume.pdf"
              download="Kokkanti_Brahmeswar_Reddy_Resume.pdf"
              className="px-6 py-3 rounded-full font-medium text-black bg-white hover:bg-gray-200 shadow-lg transition-all hover:brightness-110"
            >
              My Resume
            </a> */}
          </motion.div>
